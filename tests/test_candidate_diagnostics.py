...
from fashionrec.evaluation.candidate_diagnostics import (  # 诊断
    DIAGNOSTICS_SCHEMA_VERSION,
    assert_candidate_diagnostics_present,
    classify_purchase_stratum,
    diagnose_users,
)
from fashionrec.evaluation.experiment_report import save_candidate_diagnostics  # 落盘
from fashionrec.experiment.config import load_experiment_config  # 协议
