...
from fashionrec.industrial.evaluation.rrf_control_command import (  # Industrial RRF 对照协议
    assert_not_tuning_on_test,  # test 禁止搜权
    collect_baseline_variants,  # 变体收集
    load_frozen_fusion_weights,  # 只加载冻结权重
)  # 导入结束
from fashionrec.industrial.evaluation.experiment_report import (  # 报告
...
from fashionrec.industrial.evaluation.offline_eval import (  # 假上下文与对照收集
    FusionEvalContext,
    collect_ranker_comparison_variants,
)
from fashionrec.shared.experiment.config import REQUIRED_TIERS, load_experiment_config  # 配置
from fashionrec.industrial.ranking.fusion import ACTIVITY_WEIGHTS  # 默认 RRF 权重
