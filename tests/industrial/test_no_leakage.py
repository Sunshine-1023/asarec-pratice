...
from fashionrec.industrial.data.split import (  # 切分与 as-of 特征
...
from fashionrec.industrial.data.user_features import (  # 2.3 as-of 用户行为
    assert_user_features_ignore_future_events,
    load_item_metadata,
)
from fashionrec.industrial.data.cross_features import assert_cross_features_ignore_future_events  # 2.4 交叉
from fashionrec.industrial.data.filter import fit_train_item_universe
from fashionrec.industrial.recall.popular import build_popular_index  # 热门索引
