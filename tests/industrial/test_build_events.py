...
from fashionrec.industrial.data.events import (  # 事件构建
    EVENT_COLUMNS,  # 输出列
    aggregate_user_day_item_events,  # 纯函数
    build_events,  # CSV -> parquet
)
from fashionrec.industrial.data.command import main as data_main  # 检查 --build-events 开关
from fashionrec.industrial.data.service import processed_layout  # 产物布局
