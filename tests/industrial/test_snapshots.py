...
from fashionrec.industrial.data.command import main as data_main  # 帮助
from fashionrec.industrial.data.service import processed_layout  # 布局
from fashionrec.industrial.data.snapshots import (  # 快照
    SnapshotSpec,  # 说明
...
from fashionrec.industrial.data.split import TimeSplitResult  # 切分结果
