...
from fashionrec.data.command import main as data_main, processed_layout  # CLI / 布局
from fashionrec.data.cross_features import (  # 2.4
...
from fashionrec.data.labels import build_labels  # 标签对
