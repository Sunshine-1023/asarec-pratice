...
from fashionrec.shared.domain.candidates import Candidate  # 候选结构
from fashionrec.shared.domain.ids import canonical_item_id, canonical_user_id, submission_item_id  # ID 规范
