...
from fashionrec.data.build_baskets import (  # 购物篮
    BASKET_COLUMNS,  # 列契约
    baskets_from_events,  # 事件成篮
    build_baskets,  # CSV/事件 -> parquet
    flatten_recent_baskets,  # 按完整日截断
)
from fashionrec.data.build_events import aggregate_user_day_item_events  # 先聚合成事件
from fashionrec.data.command import main as data_main  # 帮助文本
