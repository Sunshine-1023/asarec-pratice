...
from fashionrec.industrial.data.customer_features import (  # 人群分桶
    DEFAULT_CUSTOMERS,
...
from fashionrec.industrial.data.snapshots import PARTITION_COL  # 分区键
from fashionrec.industrial.data.user_features import (  # 复用 enrichment / 截断
    DEFAULT_ARTICLES,
    enrich_events,
    history_as_of,
    load_item_metadata,
