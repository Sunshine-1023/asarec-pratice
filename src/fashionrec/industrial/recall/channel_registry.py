...
from fashionrec.industrial.recall.base import RecallChannel, RecallResult
from fashionrec.industrial.recall.category_popular import (
...
from fashionrec.industrial.recall.content import (  # 内容召回
    CONTENT_SEED_ITEMS,
    ContentIndex,
    build_content_index,
    recall_content,
)
from fashionrec.industrial.recall.repurchase import (  # 复购召回
    RepurchaseIndex,
    build_repurchase_index,
    recall_repurchase,
)
from fashionrec.industrial.recall.style import (  # 款式召回
    STYLE_SEED_ITEMS,
    StyleIndex,
    build_style_index,
    recall_style,
)
from fashionrec.industrial.recall.popular import (  # 热门召回
    PopularIndex,
    build_popular_index,
