...
from fashionrec.industrial.ranking.dataset import KEY_COLUMNS, LABEL_COLUMNS  # 非特征列
from fashionrec.industrial.ranking.features import lambda_rank_group_sizes  # group 长度
