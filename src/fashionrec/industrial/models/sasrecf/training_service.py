...
from fashionrec.industrial.models.sasrecf.checkpoints import install_validation_checkpoint_shortlist
...
def main(  # 命令行入口函数
    ...
    *,  # 后续参数仅允许关键字传递
    default_config: str | Path = "configs/industrial/models/sasrecf.yaml",
) -> None:  # 无返回值
