...
from fashionrec.industrial.data.item_features import UNKNOWN_TOKEN  # 缺失 token 默认值
from fashionrec.shared.domain.candidates import Candidate  # 候选契约
from fashionrec.shared.domain.ids import canonical_item_id, canonical_user_id  # ID
from fashionrec.industrial.ranking.features import (  # 通道证据
