...
from fashionrec.baseline.data.build_baskets import BASKET_SCHEMA_VERSION, build_baskets  # 可选按天购物篮
from fashionrec.baseline.data.build_events import EVENT_SCHEMA_VERSION, build_events  # 可选 user-day-item 事件
from fashionrec.baseline.data.build_item_features import build_item_features  # 导入商品特征构建函数
from fashionrec.baseline.data.user_features import USER_FEATURE_SCHEMA_VERSION, build_user_features  # as-of 行为特征
from fashionrec.baseline.data.cross_features import CROSS_FEATURE_SCHEMA_VERSION, build_cross_features  # 用户×商品交叉
from fashionrec.baseline.data.customer_features import (  # 用户静态画像
    CUSTOMER_FEATURE_SCHEMA_VERSION,
    DEFAULT_CUSTOMERS,
    build_customer_features,
)
from fashionrec.baseline.data.item_features import ITEM_FEATURE_SCHEMA_VERSION  # 全量商品特征语义
from fashionrec.baseline.data.build_sequences import prepare_recbole_benchmark_files, read_max_item_list_length  # 数据层序列构建
from fashionrec.baseline.data.labels import LABEL_SCHEMA_VERSION, build_labels  # 可选 next-basket 标签
from fashionrec.baseline.data.snapshots import SNAPSHOT_SCHEMA_VERSION  # 快照索引语义
from fashionrec.baseline.data.filter import run_filter  # 导入原始数据过滤函数
from fashionrec.baseline.data.manifest import SCHEMA_VERSION, build_processed_hm_manifest, write_manifest  # 数据快照清单
from fashionrec.baseline.data.preprocess import (  # 数据预处理与显式输入路径
    MAX_USER_HISTORY,
    MIN_USER_PURCHASES,
    RAW_PATH,
    WEEKS,
...
from fashionrec.baseline.data.backtest import (  # 可选多窗口回测
...
from fashionrec.baseline.data.split import (  # 时间划分与 train-only 模型子集
    TEST_WEEKS,
    TRAIN_WEEKS,
    VALID_WEEKS,
