...
from fashionrec.baseline.data.build_events import aggregate_user_day_item_events  # 无事件文件时从交易现算
from fashionrec.baseline.data.snapshots import (  # 快照协议
...
from fashionrec.baseline.data.split import TimeSplitResult  # 时间切分
