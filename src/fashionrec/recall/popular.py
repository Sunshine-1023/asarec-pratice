...
from fashionrec.data.customer_features import (  # 冷启动 age_bucket
    DEFAULT_CUSTOMERS,
    load_customers_table,
    parse_age,
)
from fashionrec.data.item_features import UNKNOWN_TOKEN, clean_category_token  # 类别 token
from fashionrec.domain.ids import canonical_item_id, canonical_user_id  # ID
from fashionrec.recall.window_scores import (  # 共享窗口逻辑
