...
from fashionrec.shared.experiment.artifacts import RunArtifacts  # 运行产物路径
from fashionrec.shared.experiment.config import ExperimentConfig, load_experiment_config  # 实验配置
