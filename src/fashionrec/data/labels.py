...
from fashionrec.data.build_events import aggregate_user_day_item_events  # 无事件文件时从交易现算
from fashionrec.data.snapshots import (  # 快照协议
...
from fashionrec.data.split import TimeSplitResult  # 时间切分
from fashionrec.domain.ids import canonical_item_id, canonical_user_id  # ID 规范
