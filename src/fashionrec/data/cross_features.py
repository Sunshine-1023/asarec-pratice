...
from fashionrec.data.customer_features import (  # 人群分桶
    DEFAULT_CUSTOMERS,
    build_customer_feature_table,
    load_customers_table,
)
from fashionrec.data.labels import load_events_for_labels  # 事件来源
from fashionrec.data.snapshots import PARTITION_COL  # 分区键
from fashionrec.data.user_features import (  # 复用 enrichment / 截断
    DEFAULT_ARTICLES,
    enrich_events,
    history_as_of,
    load_item_metadata,
